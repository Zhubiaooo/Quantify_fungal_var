# Quantify_fungal_var
This repository contains all the compiled data and code from the work "Field environments can either increase or decrease rhizosphere fungal community variation among co-occurring plant species".
